            ...
            <div className="App">
                ...
                <table className="table ">
                    ...
                    <tr>
                        ...
                        <th rowSpan="2" className="bg-danger">hombres Atendidos</th>
                        <th rowSpan="2" className="bg-danger">mujeres Atendidos</th>
                    ...
                    <tr className="tr-back">
                        <td><input  type="tex" name="periodoEscolar" id="periodoEscolar"  className="from-input" onChange={this.handleChange}  /></td>
                        <td><input  name="cuatrimestre" id="cuatrimestre" type="tex" className="from-input"onChange={this.handleChange} /></td>
                        <td> <input name="grupo" id="grupo"  type="tex" className="from-input" onChange={this.handleChange} /></td>
                        <td><input  name="hombresTA" id="hombresTA"  type="tex" className="from-input" onChange={this.handleChange} /></td>
                        <td><input name="mujeresTA" id="mujeresTA" className="from-input" onChange={this.handleChange} /></td>
                        <td><input name="hombresAtendidos" id="hombresAtendidos" className="from-input" onChange={this.handleChange} /></td>
                        <td><input name="mujeresAtendidos" id="mujeresAtendidos" className="from-input" onChange={this.handleChange} /></td>
                        <td><input name="resuelto" id="resuelto" className="from-input" onChange={this.handleChange} /></td>
                        <td><input name="canalizacion" id="canalizacion" className="from-input" onChange={this.handleChange} /></td>
                        <td><input name="casosTutor" id="casosTutor" className="from-input" onChange={this.handleChange} /></td>
                        <td><input name="casosCanaliacion" id="casosCanaliacion" className="from-input" onChange={this.handleChange} /></td>
                        ...
                        <form className="was-validated" noValidate>
                            <FormGroup>
                                <div>
                                    ...
                                    <input type="text" className="form-control" i name="periodoEscolar"  id="periodoEscolar" onChange={this.handleChange} value={form?form.periodoEscolar: ''}
                                ...
                                <div>
                                    ...
                                    <input type="text" className="form-control" i name="cuatrimestre"
                                           id="cuatrimestre" onChange={this.handleChange} value={form?form.cuatrimestre: ''}
                                           required></input>
                                </div>
                                <div>
                                    <Label >grupo</Label>
                                    <input type="text" className="form-control" onChange={this.handleChange} value={form?form.grupo: ''}
                                           i name="grupo" id="grupo"   required></input>
                                </div>
                                <ModalHeader className="text-primary">Tutorados</ModalHeader>
                                <div>
                                    <Label >Numero de hombre</Label>
                                    <input type="number" className="form-control" onChange={this.handleChange} value={form?form.hombresTA: ''}
                                       i   name="hombresTA"   id="hombresTA"   required></input>
                                </div>
                                <div>
                                    <Label >Número de Mujeres </Label>
                                    <input type="number" className="form-control" onChange={this.handleChange} value={form?form.mujeresTA: ''}
                                           id="mujeresTA" name="mujeresTA"   required></input>
                                </div>
                                <div>
                                    ...
                                    <input type="number" className="form-control" onChange={this.handleChange} value={form?form.hombresAtendidos: ''}
                                           id="hombresAtendidos" i name="hombresAtendidos" required></input>
                                    <Label >Mujeres Atendidos</Label>
                                    <input type="number" className="form-control" onChange={this.handleChange} value={form?form.mujeresAtendidos: ''}
                                           id="mujeresAtendidos"  name="mujeresAtendidos" required></input>
                                </div>
                                <ModalHeader className="text-primary"># de casos atendidos y resueltos</ModalHeader>
                                <div>
                                    <Label >Necesitó canalización</Label>
                                    <input type="text" className="form-control" onChange={this.handleChange} value={form?form.resuelto: ''}
                                           id="resuelto" name="resuelto"  required></input>
                                </div>
                                <div>
                                    <Label >Resuelto por el tutor</Label>
                                    <input type="text" className="form-control" onChange={this.handleChange} value={form?form.canalizacion: ''}
                                           id="canalizacion"  name="canalizacion" required></input>
                                </div>
                                <ModalHeader className="text-primary"># de casos atendidos en seguimiento</ModalHeader>

                                <div>
                                    <Label >Por el tutor</Label>
                                    <input type="text" className="form-control"onChange={this.handleChange} value={form?form.casosTutor: ''}
                                           id="casosTutor" name="casosTutor"   required></input>
                                </div>
                                <div>
                                    <Label >Canalizados</Label>
                                    <input type="text" className="form-control"onChange={this.handleChange} value={form?form.casosCanaliacion: ''}
                                           id="casosCanaliacion"  name="casosCanaliacion" required></input>
                                </div>
                            </FormGroup>
                        </form>
                    </ModalBody>
